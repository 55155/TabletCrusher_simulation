...
tablet = scene.add_entity(
    ...
    morph=gs.morphs.MJCF(
        ...
        scale = 1.0, pos = (0,0,0.5), euler = (0,0,0), decimate = False, convexify = False,),
    surface=gs.surfaces.Default(
        smooth=False,
    ),
    vis_mode="collision",
...
#         scale = 0.005, pos = (0.0500, 0.0500, 0.1000), euler = (0,0,0),
#     ),
# )
...
for i in range(horizon):
    scene.step()
    if i == 500:
        tablet.set_pos((0.0500, 0.0500, 0.1000))
    cam.render()
cam.stop_recording(save_to_filename="video/[20251201] Samplebag_test4.mp4")
